...
public class MualaiAdapter extends RecyclerView.Adapter<MualaiAdapter.MyViewHolder> {
    private Context context;
    private ArrayList<Product> productList;

    public MualaiAdapter(Context context, ArrayList<Product> productList) {
    ...
    @NonNull
    @Override
    public MualaiAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_productdamua, parent, false);
        return new MualaiAdapter.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull MualaiAdapter.MyViewHolder holder, int position) {
...
//            productidTextView = itemView.findViewById(R.id.textprodcutid);
            ...
            itemsp_image = itemView.findViewById(R.id.img);
