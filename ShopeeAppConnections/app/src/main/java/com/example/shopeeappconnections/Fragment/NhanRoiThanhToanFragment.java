...
public class NhanRoiThanhToanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_nhan_roi_thanh_toan, container, false);

        damua = view.findViewById(R.id.recyclerViewthanhtoanoff);
    ...
    private List<Order> getOrders() {
        ...
        if (userId != null) {
            ...
            String query = "Select * from Orders where Od_name = ? and idthanhtoan = 1 and VoidanOder = 1";
