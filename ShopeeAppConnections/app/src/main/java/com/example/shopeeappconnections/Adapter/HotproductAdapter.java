...
public class HotproductAdapter extends RecyclerView.Adapter<HotproductAdapter.MyViewHolder> {
    private Context context;
    private ArrayList<Product> productList;

    public HotproductAdapter(Context context, ArrayList<Product> productList) {
    ...
    @NonNull
    @Override
    public HotproductAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_hot, parent, false);
        return new HotproductAdapter.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull HotproductAdapter.MyViewHolder holder, int position) {
