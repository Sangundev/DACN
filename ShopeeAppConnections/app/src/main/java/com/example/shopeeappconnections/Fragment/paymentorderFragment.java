...
import com.example.shopeeappconnections.Adapter.OrderAdapter;
...
public class paymentorderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_paymentorder, container, false);

        thanhtoanr = view.findViewById(R.id.recyclerViewthanhtoanonl);
        ...
        thanhtoanr.setLayoutManager(new LinearLayoutManager(requireContext()));
        thanhtoanr.setAdapter(orderAdapter);
    ...
    private List<Order> getOrders() {
        ...
        if (userId != null) {
            ...
            String query = "Select * from Orders where Od_name = ? and idthanhtoan = 2";
