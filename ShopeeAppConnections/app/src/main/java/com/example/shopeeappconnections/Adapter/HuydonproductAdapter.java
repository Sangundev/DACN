...
public class HuydonproductAdapter extends RecyclerView.Adapter<HuydonproductAdapter.ViewHolder> {

    private Context context;
    private List<Order> orderList;

    public HuydonproductAdapter(Context context, List<Order> orderList) {
    ...
    @NonNull
    @Override
    public HuydonproductAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_hydon, parent, false);
        return new HuydonproductAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HuydonproductAdapter.ViewHolder holder, int position) {
